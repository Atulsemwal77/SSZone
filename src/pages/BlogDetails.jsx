...
import { CiFacebook, CiLinkedin, CiTwitter, CiBasketball } from "react-icons/ci";
...
const BlogDetails = () => {
    ...
    const [comments, setComments] = useState([
        {
            ...
            comment: "Great read for beginners! I finally understand how JavaScript fits in with HTML and CSS. Excited to start coding!",
            avatar: ins
        }
    ]);
    ...
    const relatedBlogs = allBlogs?.filter(blog => blog.id !== blogData?.id).slice(0, 3);
                ...
                <div className="bg-white rounded-lg shadow-md flex flex-col gap-5 items-start justify-start w-full md:w-2/3 px-3">
                    ...
                    <div className="px-2 py-8 flex flex-wrap items-start gap-6">
                        <div className="tags flex flex-wrap gap-2">
                            ...
                            <button className="py-1 px-2 rounded-md bg-gray-300 text-gray-600">Education</button>
                            <button className="py-1 px-2 rounded-md bg-gray-300 text-gray-600">Branding</button>
                            <button className="py-1 px-2 rounded-md bg-gray-300 text-gray-600">JavaScript</button>
                        </div>
                ...
                <aside className="w-full md:w-1/3 flex flex-col gap-6">
                    <div className="bg-white p-6 rounded-xl shadow">
                        ...
                        <ul className="space-y-6 py-4">
                            {[...Array(5)].map((_, i) => (
                                <li key={i} className="flex items-center gap-4 shadow-md shadow-gray-300 rounded-md p-2">
                                    <img
                                        src={related}
                                        alt="Recent Post"
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm mb-1">Phone Number</label>
                            <input
                                {...register("phoneNumber", { required: true, placeholder: "Enter your Phone Number" })}
                                className="w-full border rounded px-3 py-2 placeholder-gray-400"
                            />
                            {errors.phoneNumber && (

        ...
        <>
            ...
            <div className=' relative px-12 my-6'>
                ...
                <div className=' flex items-center gap-4 my-4'>
                    ...
                    <div className=''>
                        <h1 className='text-xl font-bold'>Russell Sprout</h1>
                        <p>April 19, 2025 AT 10: 47 PM</p>
                        <p>Great read for beginners! I finally understand how JavaScript fits in with HTML and CSS. Excited to start coding!</p>
                    </div>
                ...
                <div className='max-w-[400px] shadow-xl bg-white p-4 rounded absolute right-10 top-[-120%]'>

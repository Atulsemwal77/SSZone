...
const CourseDetailsCurriculum = () => {
  return (
    ...
    <div className=' relative px-10 my-6'>
      <h2 className='text-xl font-bold my-2'>Course MOdules</h2>
      <div className='flex flex-col gap-4  border border-gray-300 max-w-[980px]'>
        <h2 className='p-2 border-b border-gray-300 flex justify-between items-center'>Introduction to web development <img src={arrow} alt="" className='size-5'/></h2>
        <h2 className='p-2 border-b border-gray-300 flex justify-between items-center'>Frontend Development - HTML, CSS, JS <img src={arrow} alt="" className='size-5'/></h2>
        <h2 className='p-2 border-b border-gray-300 flex justify-between items-center'>Frontend Framework - React.js <img src={arrow} alt="" className='size-5'/></h2>
        <h2 className='p-2 border-b border-gray-300 flex justify-between items-center'>Version Control with Git & GitHub <img src={arrow} alt="" className='size-5'/></h2>
        <h2 className='p-2 border-b border-gray-300 flex justify-between items-center'>Backend Development with Node.js & Express <img src={arrow} alt="" className='size-5'/></h2>
        <h2 className='p-2 border-b border-gray-300 flex justify-between items-center'>Databases - MongoDB <img src={arrow} alt="" className='size-5'/></h2>
        <h2 className='p-2 border-b border-gray-300 flex justify-between items-center'>User Authentication & Authorization <img src={arrow} alt="" className='size-5'/></h2>
        <h2 className='p-2 border-b border-gray-300 flex justify-between items-center'>Deployment & Hosting <img src={arrow} alt="" className='size-5'/></h2>
        <h2 className='p-2 border-b border-gray-300 flex justify-between items-center'>Project Work <img src={arrow} alt="" className='size-5'/></h2>
      </div>

        <div className='max-w-[400px] shadow-xl bg-white p-8 rounded absolute right-10 bottom-0'>

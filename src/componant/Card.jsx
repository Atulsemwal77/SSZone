...
function Card({pageTitle, pageHeading, pageSubHeading}) {
  return (
    <>
    <div className='py-[30px] px-24 font-[Manrope]'>
    ...
    <div key={index} className='max-w-[400px] max-h-[499px] border-1 rounded-[12px] p-4 border-[#E3E3E3] flex flex-col gap-4'>
        {/* image section */}
      ...
      <div className='font-[Manrope] pb-6'>
        ...
        <p className='pb-3 font-normal text-[16px] leading-[100%] tracking-normal'>{course.description}</p>
        <div className='flex flex-row justify-between'>
            <div className='flex items-center gap-1'>
                <TiDocumentText />
                <p className='font-normal text-[16px] leading-[100%] tracking-normal'>{course.lessons} Lessons</p>
            </div>
            <div className='flex items-center gap-1'>
      ...
      <div className='flex flex-row justify-between font-[Manrope] items-center'>
        ...
        <button className='py-3 px-6 border-1 border-[#296AD2] text-[#296AD2] font-medium text-[16px] tracking-normal items-center rounded-[4px]'>Enroll Now</button>
      </div>
    </div>
    ))}
    </div>
